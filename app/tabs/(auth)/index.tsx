...
const authConfigs = {
  email: {
    ...
    alternativeRoute: '/tabs/(auth)/emailAuth',
  ...
  phone: {
    ...
    alternativeRoute: '/tabs/(auth)/mobileAuth',
    ...
    <VStack className="flex-1 justify-between mb-5">
      ...
      <VStack className="px-5">
        ...
        <VStack className="gap-3">
          ...
          <Button
            style={{ backgroundColor: Colors.light.light }}
            className="h-16 rounded-xl flex justify-center"
            onPress={() => {
