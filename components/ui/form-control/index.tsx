...
const FormControlErrorText = React.forwardRef<React.ElementRef<typeof UIFormControl.Error.Text>, IFormControlErrorTextProps>(({ className, style, size, ...props }, ref) => {
  const { size: parentSize } = useStyleContext(SCOPE);
