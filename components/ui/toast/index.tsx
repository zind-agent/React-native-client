...
const ToastTitle = React.forwardRef<React.ElementRef<typeof Text>, IToastTitleProps>(
...
const ToastDescription = React.forwardRef<React.ElementRef<typeof Text>, IToastDescriptionProps>(
